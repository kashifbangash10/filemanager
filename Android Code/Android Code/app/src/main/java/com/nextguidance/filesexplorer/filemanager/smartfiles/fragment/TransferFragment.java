...
import static com.nextguidance.filesexplorer.filemanager.smartfiles.transfer.TransferHelper.EXTRA_STATUS;
import static com.nextguidance.filesexplorer.filemanager.smartfiles.transfer.TransferHelper.EXTRA_TRANSFER;
import static com.nextguidance.filesexplorer.filemanager.smartfiles.transfer.TransferHelper.TRANSFER_UPDATED;
...
import com.nextguidance.filesexplorer.filemanager.smartfiles.ShareDeviceActivity;
import com.nextguidance.filesexplorer.filemanager.smartfiles.adapter.TransferAdapter;
...
public class TransferFragment extends RecyclerFragment
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mAdapter = new TransferAdapter(requireActivity());
    ...
    public void onStart() {
        ...
        getActivity().registerReceiver(mBroadcastReceiver, intentFilter,RECEIVER_NOT_EXPORTED);
