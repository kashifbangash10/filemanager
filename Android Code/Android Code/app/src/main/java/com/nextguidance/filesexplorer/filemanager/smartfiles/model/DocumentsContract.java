...
import com.nextguidance.filesexplorer.filemanager.smartfiles.misc.ImageUtils;
import com.nextguidance.filesexplorer.filemanager.smartfiles.misc.OsCompat;
import com.nextguidance.filesexplorer.filemanager.smartfiles.misc.Utils;
import com.nextguidance.filesexplorer.filemanager.smartfiles.provider.DocumentsProvider;
...
import static com.nextguidance.filesexplorer.filemanager.smartfiles.misc.ContentProviderClientCompat.buildAssetFileDescriptor;
import static com.nextguidance.filesexplorer.filemanager.smartfiles.misc.ContentProviderClientCompat.openTypedAssetFileDescriptor;
...
public final class DocumentsContract {
     ...
     */
    public static final String PROVIDER_INTERFACE = "com.nextguidance.filesexplorer.filemanager.smartfiles.action.DOCUMENTS_PROVIDER";
     ...
     * {@link com.nextguidance.filesexplorer.filemanager.smartfiles.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID}.
     *
    ...
    /**
     * Build URI representing the target {@link com.nextguidance.filesexplorer.filemanager.smartfiles.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} in
     * a document provider. When queried, a provider will return a single row
     * with columns defined by {@link com.nextguidance.filesexplorer.filemanager.smartfiles.model.DocumentsContract.Document}.
     *
     ...
     * Build URI representing the children of the target directory in a document
     * provider. When queried, a provider will return zero or more rows with
     * columns defined by {@link com.nextguidance.filesexplorer.filemanager.smartfiles.model.DocumentsContract.Document}.
     * <p>
     ...
     *            directory with MIME type of {@link com.nextguidance.filesexplorer.filemanager.smartfiles.model.DocumentsContract.Document#MIME_TYPE_DIR}.
     * @see Intent#ACTION_OPEN_DOCUMENT_TREE
     * @see android.provider.DocumentsProvider#isChildDocument(String, String)
    ...
    /**
     * Extract the {@link com.nextguidance.filesexplorer.filemanager.smartfiles.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} from the given URI.
     *
    ...
    /**
     * Extract the via {@link com.nextguidance.filesexplorer.filemanager.smartfiles.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} from the given URI.
     */
