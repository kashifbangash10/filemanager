...
import com.example.apps.solidfilemamnager.misc.ImageUtils;
import com.example.apps.solidfilemamnager.misc.OsCompat;
import com.example.apps.solidfilemamnager.misc.Utils;
import com.example.apps.solidfilemamnager.provider.DocumentsProvider;
import com.example.apps.solidfilemamnager.provider.ExternalStorageProvider;
import com.example.apps.solidfilemamnager.provider.UsbStorageProvider;

import static com.example.apps.solidfilemamnager.misc.ContentProviderClientCompat.buildAssetFileDescriptor;
import static com.example.apps.solidfilemamnager.misc.ContentProviderClientCompat.openTypedAssetFileDescriptor;
...
public final class DocumentsContract {
     ...
     */
    public static final String PROVIDER_INTERFACE = "com.example.apps.solidfilemamnager.action.DOCUMENTS_PROVIDER";
     ...
     * {@link com.example.apps.solidfilemamnager.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID}.
     *
    ...
    /**
     * Build URI representing the target {@link com.example.apps.solidfilemamnager.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} in
     * a document provider. When queried, a provider will return a single row
     * with columns defined by {@link com.example.apps.solidfilemamnager.model.DocumentsContract.Document}.
     *
     ...
     * Build URI representing the children of the target directory in a document
     * provider. When queried, a provider will return zero or more rows with
     * columns defined by {@link com.example.apps.solidfilemamnager.model.DocumentsContract.Document}.
     * <p>
     ...
     *            directory with MIME type of {@link com.example.apps.solidfilemamnager.model.DocumentsContract.Document#MIME_TYPE_DIR}.
     * @see Intent#ACTION_OPEN_DOCUMENT_TREE
     * @see android.provider.DocumentsProvider#isChildDocument(String, String)
    ...
    /**
     * Extract the {@link com.example.apps.solidfilemamnager.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} from the given URI.
     *
    ...
    /**
     * Extract the via {@link com.example.apps.solidfilemamnager.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} from the given URI.
     */
