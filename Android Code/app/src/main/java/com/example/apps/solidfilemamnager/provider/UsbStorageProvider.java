...
import com.example.apps.solidfilemamnager.usb.UsbUtils;



import static com.example.apps.solidfilemamnager.misc.FileUtils.getTypeForName;
...
public class UsbStorageProvider extends DocumentsProvider {
     ...
     */
    private static final String ACTION_USB_PERMISSION = "com.example.apps.solidfilemamnager.action.USB_PERMISSION";
