...
public class Utils extends UtilsFlavour {
    ...
    public static Uri getAppProStoreUri() {
        ...
        return Uri.parse("market://details?id=" + "com.example.apps.solidfilemamnager");
    }
    ...
    public static void sendEmail(Activity activity, String title, String subject) {
        ...
        result.putExtra(Intent.EXTRA_EMAIL, new String[]{"support@example.io"});
        result.putExtra(Intent.EXTRA_SUBJECT, subject);
        result.putExtra(Intent.EXTRA_TEXT, R.string.app_name+"Feedback"
