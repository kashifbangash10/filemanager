...
import com.example.apps.solidfilemamnager.libcore.io.Streams;
...
public final class PdfUtils {
    ...
    public static @Nullable AssetFileDescriptor openPdfThumbnail(File file, Point size)
        ...
        final ParcelFileDescriptor pdfDescriptor =
                ParcelFileDescriptor.open(file, ParcelFileDescriptor.MODE_READ_ONLY);
        return openPdfThumbnail(pdfDescriptor, size);
    }

    /**
     * Returns the front page of the pdf as a thumbnail
     * @param pdfDescriptor Given PDF ParcelFileDescriptor
     * @param size Cropping of the front page.
     * @return AssetFileDescriptor containing the thumbnail as a bitmap.
     * @throws IOException if the file isn't a pdf or if the file doesn't exist.
     */
    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public static @Nullable AssetFileDescriptor openPdfThumbnail(final ParcelFileDescriptor pdfDescriptor, Point size)
            throws IOException {

        Bitmap thumbnail = getPdfThumbnail(pdfDescriptor, size);
    ...
    public static Bitmap getPdfThumbnail(File file, Point size) throws IOException {
        
        final ParcelFileDescriptor pdfDescriptor =
                ParcelFileDescriptor.open(file, ParcelFileDescriptor.MODE_READ_ONLY);
        return getPdfThumbnail(pdfDescriptor, size);
    }

    public static Bitmap getPdfThumbnail(ParcelFileDescriptor pdfDescriptor, Point size) throws IOException {
