...
import com.example.apps.solidfilemamnager.BaseActivity.State.ViewMode;
import com.example.apps.solidfilemamnager.DocumentsApplication;
import com.example.apps.solidfilemamnager.R;
import com.example.apps.solidfilemamnager.libcore.util.BiConsumer;
import com.example.apps.solidfilemamnager.libcore.util.Consumer;
