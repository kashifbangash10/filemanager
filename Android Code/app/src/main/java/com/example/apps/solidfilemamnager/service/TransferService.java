package com.example.apps.solidfilemamnager.service;
...
import com.example.apps.solidfilemamnager.misc.LogUtils;
import com.example.apps.solidfilemamnager.misc.Utils;
import com.example.apps.solidfilemamnager.server.TransferServer;
import com.example.apps.solidfilemamnager.transfer.NotificationHelper;
import com.example.apps.solidfilemamnager.transfer.TransferHelper;
import com.example.apps.solidfilemamnager.transfer.model.Bundle;
import com.example.apps.solidfilemamnager.transfer.model.Device;
import com.example.apps.solidfilemamnager.transfer.model.FileItem;
import com.example.apps.solidfilemamnager.transfer.model.Transfer;

import static com.example.apps.solidfilemamnager.transfer.TransferHelper.ACTION_BROADCAST;
import static com.example.apps.solidfilemamnager.transfer.TransferHelper.ACTION_REMOVE_TRANSFER;
import static com.example.apps.solidfilemamnager.transfer.TransferHelper.ACTION_START_LISTENING;
import static com.example.apps.solidfilemamnager.transfer.TransferHelper.ACTION_START_TRANSFER;
import static com.example.apps.solidfilemamnager.transfer.TransferHelper.ACTION_STOP_LISTENING;
import static com.example.apps.solidfilemamnager.transfer.TransferHelper.ACTION_STOP_TRANSFER;
import static com.example.apps.solidfilemamnager.transfer.TransferHelper.EXTRA_DEVICE;
import static com.example.apps.solidfilemamnager.transfer.TransferHelper.EXTRA_ID;
import static com.example.apps.solidfilemamnager.transfer.TransferHelper.EXTRA_TRANSFER;
import static com.example.apps.solidfilemamnager.transfer.TransferHelper.EXTRA_URIS;
import static com.example.apps.solidfilemamnager.transfer.TransferHelper.getAssetFileDescriptor;
import static com.example.apps.solidfilemamnager.transfer.TransferHelper.getFilename;
import static com.example.apps.solidfilemamnager.transfer.TransferHelper.traverseDirectory;
