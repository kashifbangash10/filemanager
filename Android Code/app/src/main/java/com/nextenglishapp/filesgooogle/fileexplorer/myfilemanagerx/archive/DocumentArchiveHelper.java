...
package com.nextenglishapp.filesgooogle.fileexplorer.myfilemanagerx.archive;
...
import com.nextenglishapp.filesgooogle.fileexplorer.myfilemanagerx.misc.Preconditions;
...
public class DocumentArchiveHelper implements Closeable {
    ...
    private Loader getInstanceUncheckedLocked(String documentId)
        ...
        try {
            ...
            cursor.moveToFirst();
            @SuppressLint("Range") final String mimeType = cursor.getString(cursor.getColumnIndex(
            ...
            try {
                if (mLocalFile != null) {
                    ...
                    mArchive = DocumentArchive.createForParcelFileDescriptor(
                            ...
                            mProvider.openDocument(mId.mArchiveId, "r", null ),
