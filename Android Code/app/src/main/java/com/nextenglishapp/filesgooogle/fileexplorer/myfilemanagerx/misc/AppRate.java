...
import static com.nextenglishapp.filesgooogle.fileexplorer.myfilemanagerx.R.id.action_close;
import static com.nextenglishapp.filesgooogle.fileexplorer.myfilemanagerx.R.id.action_feedback;
import static com.nextenglishapp.filesgooogle.fileexplorer.myfilemanagerx.R.id.action_rate;
import static com.nextenglishapp.filesgooogle.fileexplorer.myfilemanagerx.R.id.action_support;
import static com.nextenglishapp.filesgooogle.fileexplorer.myfilemanagerx.misc.Utils.openFeedback;
import static com.nextenglishapp.filesgooogle.fileexplorer.myfilemanagerx.misc.Utils.openPlaystore;
...
public class AppRate implements View.OnClickListener {
    ...
    public static AppRate with(Activity activity) {
        ...
        instance.text = "Enjoying the app? Spread the word!";
