...
import com.nextenglishapp.filesgooogle.fileexplorer.myfilemanagerx.fragment.RootsFragment.GroupItem;
...
public class RootsExpandableAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        GroupItem item = new GroupItem((GroupInfo) getGroup(groupPosition));
