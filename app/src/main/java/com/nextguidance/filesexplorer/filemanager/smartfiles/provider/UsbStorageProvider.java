...
import com.nextguidance.filesexplorer.filemanager.smartfiles.usb.UsbUtils;



import static com.nextguidance.filesexplorer.filemanager.smartfiles.misc.FileUtils.getTypeForName;
...
public class UsbStorageProvider extends DocumentsProvider {
     ...
     */
    private static final String ACTION_USB_PERMISSION = "com.nextguidance.filesexplorer.filemanager.smartfiles.action.USB_PERMISSION";
